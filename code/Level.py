...
from code.Const import WIN_WIDTH, WIN_HEIGHT, MENU_OPTION, C_BLACK, SNAKE_VELOCITY, PATH_BG_IMAGEM, BLOCK_SIZE
    ...
    def to_update (self):
        if self.snake.alive:
            ...
            if x >= WIN_WIDTH:
                ...
                x = 0 - BLOCK_SIZE  # O -20 do block serve para compesar a andada da cobra
                ...
                y = 0 - BLOCK_SIZE  # O -20 do block serve para compesar a andada da cobra
